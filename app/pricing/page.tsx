      ...
      <main className="max-w-4xl mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-2xl mx-auto">
          ...
          <div className="bg-white rounded-2xl border-2 border-[#EE4D2D] p-8 shadow-lg relative">
            ...
            <div className="mb-6">
              ...
              <p className="text-3xl font-bold text-gray-900">
                R$ 19,90
                <span className="text-sm font-normal text-gray-400">/30 dias</span>
              </p>
            </div>
            ...
            <ul className="space-y-3 mb-8">
              {[
                ...
                <li key={f} className="flex items-center gap-3 text-sm text-gray-600">
                  <svg className="w-4 h-4 text-[#EE4D2D] shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  {f}
                </li>
        ...
        <div className="mt-12 max-w-xl mx-auto bg-white rounded-2xl border border-gray-100 p-6 text-center shadow-sm">
          ...
          <div className="text-sm text-gray-500 space-y-1.5 text-left max-w-sm mx-auto">
            <p>1. Clique em &quot;Ativar Premium via PIX&quot;</p>
